...
if(isset($_POST["submit"]))
{
	...
	if($error == '')
	{
		...
		$file_open = fopen("paintball.csv", "a");
		$no_rows = count(file("paintball.csv"));
		 if($no_rows > 1)
		{
			$no_rows = ($no_rows - 1) + 1;
		}
...
<html lang="en">
  <head>
    <title>Apratim 2K18 | Register - Paintball</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md">
            <div class="ftco-footer-widget mb-4">
              ...
              <img src="images/aplogo.svg" height="100px">
            </div>
          </div>
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
          ...
          <div class="col-md">
             <div class="ftco-footer-widget mb-4">
              ...
              <ul class="list-unstyled">
                ...
                <li><a href="#" class="py-2 d-block">ccetapratim18@gmail.com</a></li>
              </ul>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-md-12 text-center">
            <p>Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | CCET</p>
