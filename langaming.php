...
if(isset($_POST["submit"]))
{
	...
	if($error == '')
	{
		...
		$file_open = fopen("langaming.csv", "a");
		$no_rows = count(file("langaming.csv"));
		 if($no_rows > 1)
		{
			$no_rows = ($no_rows - 1) + 1;
		}
...
<section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url('images/nfs2.jpg');">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center text-center">
            <div class="col-md-10 col-sm-12 ftco-animate">
			<img src="images/aplogo.svg" height="400px">
              <h1 class="mb-3" style="border:0px dashed white;">Lan Gaming</h1>
           </div>
          </div>
        </div>
      </div>
    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-4 ftco-animate img" style="background-image: url(images/pubg1.jpg);"></div>
