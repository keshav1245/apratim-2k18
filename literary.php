...
if(isset($_POST["submit"]))
{
	...
	if($error == '')
	{
		...
		$file_open = fopen("literary.csv", "a");
		$no_rows = count(file("literary.csv"));
		 if($no_rows > 1)
		{
			$no_rows = ($no_rows - 1) + 1;
		}
...
<html lang="en">
  <head>
    <title>APRATIM 2K18 | Register - Literary</title>
    <meta charset="utf-8">
...
<section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url('images/spellbee1.jpg');">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center text-center">
            <div class="col-md-10 col-sm-12 ftco-animate">
			<img src="images/aplogo.svg" height="400px">
              <h1 class="mb-3">Literary Events</h1>
           </div>
          </div>
        </div>
      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="select-wrap one-third">
                      ...
                      <select name="eventname" required id="" class="form-control" >
                        ...
                        <option value="Debate English">Debate English</option>
                        <option value="Spell Bee">Quiz</option>
