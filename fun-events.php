...
if(isset($_POST["submit"]))
{
	...
	if($error == '')
	{
		...
		$file_open = fopen("fun.csv", "a");
		$no_rows = count(file("fun.csv"));
		 if($no_rows > 1)
		{
			$no_rows = ($no_rows - 1) + 1;
		}
...
<html lang="en">
  <head>
    <title>Apratim 2k18 | Register - Fun Events</title>
    <meta charset="utf-8">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="index.html#sponsers" class="nav-link">Our Sponsors</a></li>
            <li class="nav-item active"><a href="index.html#events" class="nav-link">Our Events</a></li>
...
<section class="home-slider owl-carousel">
      <div class="slider-item" style="background-image: url('images/fun1.jpg');">
        <div class="overlay"></div>
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center text-center">
            <div class="col-md-10 col-sm-12 ftco-animate">
			<img src="images/aplogo.svg" height="400px">
              <h1 class="mb-3"> Fun Events</h1>
           </div>
          </div>
        </div>
      </div>
    ...
    <section class="ftco-section">
      <div class="container">
        ...
        <div class="row d-flex">
          <div class="col-md-4 ftco-animate img" style="background-image: url(images/fun4.jpg);"></div>
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="tname" id="tname" class="form-control" required placeholder="Team Name">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="">Institute</label>
                    <input type="text" name="institute" id="institute" class="form-control" required placeholder="College/Institute Name">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="select-wrap one-third">
                      <div class="icon"><span class="ion-ios-arrow-down"></span></div>
                      <select name="eventname" required id="eventname" class="form-control">
                        <option value="">Event Name</option>
                        <option value="Treasure Hunt">Treasure Hunt</option>
                        <option value="Rangoli Designing">Rangoli Designing</option>
                        <option value="Bhangra Wars">Bhangra Wars</option>
                        <option value="Truth and Dare">Truth & Dare</option>
                        <option value="Gems and Straw">Gems & Straw</option>
                ...
                <div class="form-group">
                    <input type="checkbox" name="toggle" id="toggle" onchange="isChecked(this, 'submit')"> I am solely responsible of all my details filled and action during the fest.
                </div>
